...
First the load the `data.table` package (hint: use the `library()` function). Then
...
2· Calculate a new variables called `PropF` and `PropM` for the proportion of females and males, respectively.
